    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-slate-800 rounded-2xl p-8 border border-primary/20">
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-white dark:bg-slate-700 rounded-lg shadow-sm">
                  <div className="w-3 h-3 rounded-full bg-blue-500" />
                  <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">Open Issues</span>
                </div>
                <div className="flex items-center gap-3 p-4 bg-white dark:bg-slate-700 rounded-lg shadow-sm">
                  <div className="w-3 h-3 rounded-full bg-amber-500" />
                  <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">In Progress</span>
                </div>
                <div className="flex items-center gap-3 p-4 bg-white dark:bg-slate-700 rounded-lg shadow-sm">
                  <div className="w-3 h-3 rounded-full bg-emerald-500" />
                  <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">Resolved</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-20">
          <Card className="border-none bg-slate-50 dark:bg-slate-800 hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">Issues Reported</p>
                  <p className="text-3xl font-bold text-slate-900 dark:text-white mt-2">{typeof issueCount === 'number' ? issueCount : 0}</p>
                </div>
          ...
          <Card className="border-none bg-slate-50 dark:bg-slate-800 hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">Active Contributors</p>
                  <p className="text-3xl font-bold text-slate-900 dark:text-white mt-2">1.2K+</p>
                </div>
                <div className="bg-primary/10 p-3 rounded-lg">
          ...
          <Card className="border-none bg-slate-50 dark:bg-slate-800 hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">Issues Resolved</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="border-none bg-white dark:bg-slate-800 hover:shadow-lg transition-shadow">
            <CardContent className="p-8">
              <div className="bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <MapPin className="h-6 w-6 text-primary" />
              </div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Interactive Map</h3>
